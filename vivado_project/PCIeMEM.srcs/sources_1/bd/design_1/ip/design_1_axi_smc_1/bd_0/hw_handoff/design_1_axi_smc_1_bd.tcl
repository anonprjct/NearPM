...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M00_S12_CONNECTIVITY {0} \
   CONFIG.M00_S13_CONNECTIVITY {0} \
   ...
   CONFIG.M01_S11_CONNECTIVITY {1} \
   CONFIG.M01_S12_CONNECTIVITY {0} \
   CONFIG.M01_S13_CONNECTIVITY {0} \
   CONFIG.M01_S14_CONNECTIVITY {0} \
   ...
   CONFIG.M02_S07_CONNECTIVITY {1} \
   CONFIG.M02_S08_CONNECTIVITY {1} \
   CONFIG.M02_S09_CONNECTIVITY {1} \
   CONFIG.M02_S10_CONNECTIVITY {1} \
   CONFIG.M02_S11_CONNECTIVITY {1} \
   CONFIG.M02_S12_CONNECTIVITY {0} \
   CONFIG.M02_S13_CONNECTIVITY {0} \
   CONFIG.M02_S14_CONNECTIVITY {0} \
   CONFIG.M_PIPELINES {1} \
   CONFIG.NUM_MI {3} \
   CONFIG.NUM_SI {15} \
   CONFIG.PAYLD_WIDTH {263} \
   CONFIG.S_LATENCY {0} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.M07_S02_CONNECTIVITY {1} \
   CONFIG.M08_S00_CONNECTIVITY {1} \
   CONFIG.M08_S01_CONNECTIVITY {0} \
   CONFIG.M08_S02_CONNECTIVITY {1} \
   CONFIG.M09_S00_CONNECTIVITY {1} \
   CONFIG.M09_S01_CONNECTIVITY {0} \
   CONFIG.M09_S02_CONNECTIVITY {1} \
   CONFIG.M10_S00_CONNECTIVITY {1} \
   CONFIG.M10_S01_CONNECTIVITY {0} \
   CONFIG.M10_S02_CONNECTIVITY {1} \
   CONFIG.M11_S00_CONNECTIVITY {1} \
   CONFIG.M11_S01_CONNECTIVITY {1} \
   CONFIG.M11_S02_CONNECTIVITY {1} \
   CONFIG.M12_S00_CONNECTIVITY {0} \
   CONFIG.M12_S01_CONNECTIVITY {0} \
   CONFIG.M12_S02_CONNECTIVITY {0} \
   CONFIG.M13_S00_CONNECTIVITY {0} \
   CONFIG.M13_S01_CONNECTIVITY {0} \
   CONFIG.M13_S02_CONNECTIVITY {0} \
   CONFIG.M14_S00_CONNECTIVITY {0} \
   CONFIG.M14_S01_CONNECTIVITY {0} \
   CONFIG.M14_S02_CONNECTIVITY {0} \
   CONFIG.M_PIPELINES {1} \
   CONFIG.NUM_MI {15} \
   CONFIG.NUM_SI {3} \
...
proc create_hier_cell_s11_nodes { parentCell nameHier } {
  ...
  # Create instance: s11_ar_node, and set properties
  set s11_ar_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s11_ar_node ]
  set_property -dict [ list \
  ...
  # Create instance: s11_r_node, and set properties
  set s11_r_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s11_r_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_SC_AR_1 [get_bd_intf_pins S_SC_AR] [get_bd_intf_pins s11_ar_node/S_SC]
  ...
  connect_bd_intf_net -intf_net S_SC_R_1 [get_bd_intf_pins S_SC_R] [get_bd_intf_pins s11_r_node/S_SC]
  connect_bd_intf_net -intf_net S_SC_W_1 [get_bd_intf_pins S_SC_W] [get_bd_intf_pins s11_w_node/S_SC]
  connect_bd_intf_net -intf_net s11_ar_node_M_SC [get_bd_intf_pins M_SC_AR] [get_bd_intf_pins s11_ar_node/M_SC]
  ...
  connect_bd_intf_net -intf_net s11_r_node_M_SC [get_bd_intf_pins M_SC_R] [get_bd_intf_pins s11_r_node/M_SC]
  connect_bd_intf_net -intf_net s11_w_node_M_SC [get_bd_intf_pins M_SC_W] [get_bd_intf_pins s11_w_node/M_SC]

  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s11_ar_node/m_sc_aclk] [get_bd_pins s11_aw_node/m_sc_aclk] [get_bd_pins s11_b_node/s_sc_aclk] [get_bd_pins s11_r_node/s_sc_aclk] [get_bd_pins s11_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s11_ar_node/m_sc_aresetn] [get_bd_pins s11_aw_node/m_sc_aresetn] [get_bd_pins s11_b_node/s_sc_aresetn] [get_bd_pins s11_r_node/s_sc_aresetn] [get_bd_pins s11_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s11_ar_node/s_sc_aclk] [get_bd_pins s11_aw_node/s_sc_aclk] [get_bd_pins s11_b_node/m_sc_aclk] [get_bd_pins s11_r_node/m_sc_aclk] [get_bd_pins s11_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s11_ar_node/s_sc_aresetn] [get_bd_pins s11_aw_node/s_sc_aresetn] [get_bd_pins s11_b_node/m_sc_aresetn] [get_bd_pins s11_r_node/m_sc_aresetn] [get_bd_pins s11_w_node/s_sc_aresetn]
...
proc create_hier_cell_s09_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s09_aw_node/m_sc_aclk] [get_bd_pins s09_b_node/s_sc_aclk] [get_bd_pins s09_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s09_aw_node/m_sc_aresetn] [get_bd_pins s09_b_node/s_sc_aresetn] [get_bd_pins s09_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s09_aw_node/s_sc_aclk] [get_bd_pins s09_b_node/m_sc_aclk] [get_bd_pins s09_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s09_aw_node/s_sc_aresetn] [get_bd_pins s09_b_node/m_sc_aresetn] [get_bd_pins s09_w_node/s_sc_aresetn]
...
proc create_hier_cell_m02_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {32} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b000000000000000} \
   CONFIG.SSC001_ROUTE {0b000000000000000} \
   CONFIG.SSC002_ROUTE {0b000000000000000} \
   CONFIG.SSC003_ROUTE {0b000000000000000} \
   CONFIG.SSC004_ROUTE {0b000000000000000} \
   CONFIG.SSC005_ROUTE {0b000000000000000} \
   CONFIG.SSC006_ROUTE {0b000000000000000} \
   CONFIG.SSC007_ROUTE {0b000000000000000} \
   CONFIG.SSC008_ROUTE {0b000100000000000} \
   CONFIG.SSC009_ROUTE {0b000100000000000} \
   CONFIG.SSC010_ROUTE {0b000000000000000} \
   CONFIG.SSC011_ROUTE {0b000000000000000} \
   CONFIG.SSC012_ROUTE {0b000100000000000} \
   CONFIG.SSC013_ROUTE {0b000100000000000} \
   CONFIG.SSC014_ROUTE {0b000100000000000} \
   CONFIG.SSC015_ROUTE {0b000100000000000} \
   CONFIG.SSC016_ROUTE {0b000100000000000} \
   CONFIG.SSC017_ROUTE {0b000100000000000} \
   CONFIG.SSC018_ROUTE {0b000100000000000} \
   CONFIG.SSC019_ROUTE {0b000100000000000} \
   CONFIG.SSC020_ROUTE {0b000000000000001} \
   CONFIG.SSC021_ROUTE {0b000000000000000} \
   CONFIG.SSC022_ROUTE {0b000000000000000} \
   CONFIG.SSC023_ROUTE {0b000000000000000} \
   CONFIG.SSC024_ROUTE {0b000000000000000} \
   CONFIG.SSC025_ROUTE {0b000000000000000} \
   CONFIG.SSC026_ROUTE {0b000000000000000} \
   CONFIG.SSC027_ROUTE {0b000000000000000} \
   CONFIG.SSC028_ROUTE {0b000000000000000} \
   CONFIG.SSC029_ROUTE {0b000000000000000} \
   CONFIG.SSC030_ROUTE {0b000000000000000} \
   CONFIG.SSC031_ROUTE {0b000000000000010} \
   CONFIG.SSC032_ROUTE {0b000000000000100} \
   CONFIG.SSC033_ROUTE {0b000000000010000} \
   CONFIG.SSC034_ROUTE {0b000000000100000} \
   CONFIG.SSC035_ROUTE {0b000000100000000} \
   CONFIG.SSC036_ROUTE {0b000000010000000} \
   CONFIG.SSC037_ROUTE {0b000010000000000} \
   CONFIG.SSC038_ROUTE {0b000001000000000} \
   CONFIG.SSC039_ROUTE {0b000000000001000} \
   CONFIG.SSC040_ROUTE {0b000000001000000} \
   CONFIG.SSC041_ROUTE {0b000000000000000} \
   CONFIG.SSC042_ROUTE {0b000000000000000} \
   CONFIG.SSC043_ROUTE {0b000000000000000} \
   CONFIG.SSC044_ROUTE {0b000000000000000} \
   CONFIG.SSC045_ROUTE {0b000000000000000} \
   CONFIG.SSC046_ROUTE {0b000000000000000} \
   CONFIG.SSC047_ROUTE {0b000000000000000} \
   CONFIG.SSC048_ROUTE {0b000000000000000} \
   CONFIG.SSC049_ROUTE {0b000000000000000} \
   CONFIG.SSC050_ROUTE {0b000000000000000} \
   CONFIG.SSC051_ROUTE {0b000000000000000} \
   CONFIG.SSC052_ROUTE {0b000000000000000} \
   CONFIG.SSC053_ROUTE {0b000000000000000} \
   CONFIG.SSC054_ROUTE {0b000000000000000} \
   CONFIG.SSC055_ROUTE {0b000000000000000} \
   CONFIG.SSC056_ROUTE {0b000000000000000} \
   CONFIG.SSC057_ROUTE {0b000000000000000} \
   CONFIG.SSC058_ROUTE {0b000000000000000} \
   CONFIG.SSC059_ROUTE {0b000000000000000} \
   CONFIG.SSC060_ROUTE {0b000000000000000} \
   CONFIG.SSC061_ROUTE {0b000000000000000} \
   CONFIG.SSC062_ROUTE {0b000000000000000} \
   CONFIG.SSC063_ROUTE {0b000000000000000} \
   CONFIG.SSC_ROUTE_WIDTH {15} \
   CONFIG.S_ID_WIDTH {6} \
   CONFIG.WDATA_WIDTH {32} \
 ] $m02_exit
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M02_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins aclk1] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk2_net [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins S07_ACLK] [get_bd_pins S08_ACLK] [get_bd_pins S09_ACLK] [get_bd_pins S10_ACLK] [get_bd_pins aclk2] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk2/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins M01_ACLK] [get_bd_pins S11_ACLK] [get_bd_pins S12_ACLK] [get_bd_pins S13_ACLK] [get_bd_pins S14_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M02_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
  connect_bd_net -net psr_aclk2_interconnect_aresetn [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins S08_ARESETN] [get_bd_pins S09_ARESETN] [get_bd_pins S10_ARESETN] [get_bd_pins psr_aclk2/interconnect_aresetn]
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins M01_ARESETN] [get_bd_pins S11_ARESETN] [get_bd_pins S12_ARESETN] [get_bd_pins S13_ARESETN] [get_bd_pins S14_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:S11_AXI:S12_AXI:S13_AXI:S14_AXI} \
 ] $aclk
  set aclk1 [ create_bd_port -dir I -type clk aclk1 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M02_AXI:S00_AXI} \
 ] $aclk1
  set aclk2 [ create_bd_port -dir I -type clk aclk2 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI:S07_AXI:S08_AXI:S09_AXI:S10_AXI} \
 ] $aclk2
  ...
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins s08_axi2sc/M_SC_AR] [get_bd_intf_pins s08_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_7 [get_bd_intf_pins s10_axi2sc/M_SC_AR] [get_bd_intf_pins s10_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_8 [get_bd_intf_pins s11_axi2sc/M_SC_AR] [get_bd_intf_pins s11_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_9 [get_bd_intf_pins m00_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M00_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_10 [get_bd_intf_pins m01_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M01_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_11 [get_bd_intf_pins m02_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M02_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_3 [get_bd_intf_pins s03_axi2sc/M_SC_AW] [get_bd_intf_pins s03_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_4 [get_bd_intf_pins s05_axi2sc/M_SC_AW] [get_bd_intf_pins s05_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins s06_axi2sc/M_SC_AW] [get_bd_intf_pins s06_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_6 [get_bd_intf_pins s07_axi2sc/M_SC_AW] [get_bd_intf_pins s07_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_7 [get_bd_intf_pins s09_axi2sc/M_SC_AW] [get_bd_intf_pins s09_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins s11_axi2sc/M_SC_AW] [get_bd_intf_pins s11_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_9 [get_bd_intf_pins m00_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M00_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_10 [get_bd_intf_pins m01_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M01_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_11 [get_bd_intf_pins m02_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M02_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_3 [get_bd_intf_pins s03_nodes/S_SC_B] [get_bd_intf_pins switchboards/M03_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_4 [get_bd_intf_pins s05_nodes/S_SC_B] [get_bd_intf_pins switchboards/M05_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins s06_nodes/S_SC_B] [get_bd_intf_pins switchboards/M06_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_6 [get_bd_intf_pins s07_nodes/S_SC_B] [get_bd_intf_pins switchboards/M07_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_7 [get_bd_intf_pins s09_nodes/S_SC_B] [get_bd_intf_pins switchboards/M09_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins s11_nodes/S_SC_B] [get_bd_intf_pins switchboards/M11_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_9 [get_bd_intf_pins m00_nodes/S_SC_B] [get_bd_intf_pins m00_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_10 [get_bd_intf_pins m01_nodes/S_SC_B] [get_bd_intf_pins m01_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_11 [get_bd_intf_pins m02_nodes/S_SC_B] [get_bd_intf_pins m02_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins s08_nodes/S_SC_R] [get_bd_intf_pins switchboards/M08_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_7 [get_bd_intf_pins s10_nodes/S_SC_R] [get_bd_intf_pins switchboards/M10_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_8 [get_bd_intf_pins s11_nodes/S_SC_R] [get_bd_intf_pins switchboards/M11_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_9 [get_bd_intf_pins m00_nodes/S_SC_R] [get_bd_intf_pins m00_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_10 [get_bd_intf_pins m01_nodes/S_SC_R] [get_bd_intf_pins m01_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_11 [get_bd_intf_pins m02_nodes/S_SC_R] [get_bd_intf_pins m02_sc2axi/M_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_3 [get_bd_intf_pins s03_axi2sc/M_SC_W] [get_bd_intf_pins s03_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_4 [get_bd_intf_pins s05_axi2sc/M_SC_W] [get_bd_intf_pins s05_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins s06_axi2sc/M_SC_W] [get_bd_intf_pins s06_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_6 [get_bd_intf_pins s07_axi2sc/M_SC_W] [get_bd_intf_pins s07_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_7 [get_bd_intf_pins s09_axi2sc/M_SC_W] [get_bd_intf_pins s09_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins s11_axi2sc/M_SC_W] [get_bd_intf_pins s11_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_9 [get_bd_intf_pins m00_nodes/S_SC_W] [get_bd_intf_pins switchboards/M00_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_10 [get_bd_intf_pins m01_nodes/S_SC_W] [get_bd_intf_pins switchboards/M01_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_11 [get_bd_intf_pins m02_nodes/S_SC_W] [get_bd_intf_pins switchboards/M02_SC_W]
  ...
  connect_bd_intf_net -intf_net s11_nodes_M_SC_AR [get_bd_intf_pins s11_nodes/M_SC_AR] [get_bd_intf_pins switchboards/S11_SC_AR]
  ...
  connect_bd_intf_net -intf_net s11_nodes_M_SC_R [get_bd_intf_pins s11_axi2sc/S_SC_R] [get_bd_intf_pins s11_nodes/M_SC_R]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins m02_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins s03_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins s05_nodes/m_sc_clk] [get_bd_pins s06_nodes/m_sc_clk] [get_bd_pins s07_nodes/m_sc_clk] [get_bd_pins s08_nodes/m_sc_clk] [get_bd_pins s09_nodes/m_sc_clk] [get_bd_pins s10_nodes/m_sc_clk] [get_bd_pins s11_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins m02_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins s03_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins s05_nodes/m_sc_resetn] [get_bd_pins s06_nodes/m_sc_resetn] [get_bd_pins s07_nodes/m_sc_resetn] [get_bd_pins s08_nodes/m_sc_resetn] [get_bd_pins s09_nodes/m_sc_resetn] [get_bd_pins s10_nodes/m_sc_resetn] [get_bd_pins s11_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
