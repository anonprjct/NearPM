...
proc create_hier_cell_m01_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC032_ROUTE {0b0} \
   CONFIG.SSC033_ROUTE {0b0} \
   CONFIG.SSC034_ROUTE {0b0} \
   CONFIG.SSC035_ROUTE {0b0} \
   CONFIG.SSC036_ROUTE {0b0} \
   CONFIG.SSC037_ROUTE {0b0} \
   CONFIG.SSC038_ROUTE {0b0} \
   CONFIG.SSC039_ROUTE {0b0} \
   CONFIG.SSC040_ROUTE {0b0} \
   CONFIG.SSC041_ROUTE {0b0} \
   CONFIG.SSC042_ROUTE {0b0} \
   CONFIG.SSC043_ROUTE {0b0} \
   CONFIG.SSC044_ROUTE {0b0} \
   CONFIG.SSC045_ROUTE {0b0} \
   CONFIG.SSC046_ROUTE {0b0} \
   CONFIG.SSC047_ROUTE {0b0} \
   CONFIG.SSC048_ROUTE {0b0} \
   CONFIG.SSC049_ROUTE {0b0} \
   CONFIG.SSC050_ROUTE {0b0} \
   CONFIG.SSC051_ROUTE {0b0} \
   CONFIG.SSC052_ROUTE {0b0} \
   CONFIG.SSC053_ROUTE {0b0} \
   CONFIG.SSC054_ROUTE {0b0} \
   CONFIG.SSC055_ROUTE {0b0} \
   CONFIG.SSC056_ROUTE {0b0} \
   CONFIG.SSC057_ROUTE {0b0} \
   CONFIG.SSC058_ROUTE {0b0} \
   CONFIG.SSC059_ROUTE {0b0} \
   CONFIG.SSC060_ROUTE {0b0} \
   CONFIG.SSC061_ROUTE {0b0} \
   CONFIG.SSC062_ROUTE {0b0} \
   CONFIG.SSC063_ROUTE {0b0} \
