...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: memops_scheduler_0, and set properties
	set memops_scheduler_0 [ create_bd_cell -type ip -vlnv user.org:user:memops_scheduler:1.1 memops_scheduler_0 ]
	...
	# Connect all clock & reset of memops_scheduler_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins memops_scheduler_0/S00_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of memops_scheduler_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins memops_scheduler_0/M00_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m00_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins memops_scheduler_0/m00_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m00_axi_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins memops_scheduler_0/M01_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m01_axi_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins memops_scheduler_0/m01_axi_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins memops_scheduler_0/m01_axi_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S02_AXI] [get_bd_intf_pins memops_scheduler_0/M02_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m02_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m02_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m02_axi_txn_done] [get_bd_pins xlconcat_0/In4]
	connect_bd_net [get_bd_pins memops_scheduler_0/m02_axi_error] [get_bd_pins xlconcat_0/In5]
	connect_bd_net [get_bd_pins memops_scheduler_0/m02_axi_init_axi_txn] [ get_bd_pins slice_block/Dout2 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S03_AXI] [get_bd_intf_pins memops_scheduler_0/M03_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m03_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m03_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m03_axi_txn_done] [get_bd_pins xlconcat_0/In6]
	connect_bd_net [get_bd_pins memops_scheduler_0/m03_axi_error] [get_bd_pins xlconcat_0/In7]
	connect_bd_net [get_bd_pins memops_scheduler_0/m03_axi_init_axi_txn] [ get_bd_pins slice_block/Dout3 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S04_AXI] [get_bd_intf_pins memops_scheduler_0/M04_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m04_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m04_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m04_axi_txn_done] [get_bd_pins xlconcat_0/In8]
	connect_bd_net [get_bd_pins memops_scheduler_0/m04_axi_error] [get_bd_pins xlconcat_0/In9]
	connect_bd_net [get_bd_pins memops_scheduler_0/m04_axi_init_axi_txn] [ get_bd_pins slice_block/Dout4 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S05_AXI] [get_bd_intf_pins memops_scheduler_0/M05_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m05_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m05_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m05_axi_txn_done] [get_bd_pins xlconcat_0/In10]
	connect_bd_net [get_bd_pins memops_scheduler_0/m05_axi_error] [get_bd_pins xlconcat_0/In11]
	connect_bd_net [get_bd_pins memops_scheduler_0/m05_axi_init_axi_txn] [ get_bd_pins slice_block/Dout5 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S06_AXI] [get_bd_intf_pins memops_scheduler_0/M06_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m06_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m06_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m06_axi_txn_done] [get_bd_pins xlconcat_0/In12]
	connect_bd_net [get_bd_pins memops_scheduler_0/m06_axi_error] [get_bd_pins xlconcat_0/In13]
	connect_bd_net [get_bd_pins memops_scheduler_0/m06_axi_init_axi_txn] [ get_bd_pins slice_block/Dout6 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S07_AXI] [get_bd_intf_pins memops_scheduler_0/M07_AXI]
	connect_bd_net [get_bd_pins memops_scheduler_0/m07_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins memops_scheduler_0/m07_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins memops_scheduler_0/m07_axi_txn_done] [get_bd_pins xlconcat_0/In14]
	connect_bd_net [get_bd_pins memops_scheduler_0/m07_axi_error] [get_bd_pins xlconcat_0/In15]
	connect_bd_net [get_bd_pins memops_scheduler_0/m07_axi_init_axi_txn] [ get_bd_pins slice_block/Dout7 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of memops_scheduler_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M00_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M01_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M02_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M03_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M04_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M05_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M06_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {memops_scheduler_0/M07_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} CONFIG.C_M02_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000200} CONFIG.C_M03_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000300} CONFIG.C_M04_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000400} CONFIG.C_M05_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000500} CONFIG.C_M06_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000600} CONFIG.C_M07_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000700} ] [get_bd_cells memops_scheduler_0]

	# Copy all address to memops_scheduler_v1_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/memops_scheduler_v1_1_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_memops_scheduler_0_S00_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:memops_scheduler:1.1]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/memops_scheduler_v1_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "memops_scheduler_v1_1_hw_${i}"
