# Runtime Tcl commands to interact with - memops_scheduler_v1_1

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/memops_scheduler_v1_1_include.tcl
...
set DE [ get_done_and_error_bit $rdata_tmp 8 0 ]
# Compare read data
if { $DE == 01 } {
...
set DE [ get_done_and_error_bit $rdata_tmp 8 1 ]
# Compare read data
if { $DE == 01 } {
...
set DE [ get_done_and_error_bit $rdata_tmp 8 2 ]
# Compare read data
if { $DE == 01 } {
...
# Test: M03_AXI
set wdata_m03_axi [get_init_data 3]
create_hw_axi_txn w_m03_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m03_axi}
create_hw_axi_txn r_m03_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m03_axi_addr
run_hw_axi w_m03_axi_addr
run_hw_axi r_m03_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m03_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 8 3 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M03_AXI"
} else {
	puts "Data comparison test fail for - M03_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M04_AXI
set wdata_m04_axi [get_init_data 4]
create_hw_axi_txn w_m04_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m04_axi}
create_hw_axi_txn r_m04_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m04_axi_addr
run_hw_axi w_m04_axi_addr
run_hw_axi r_m04_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m04_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 8 4 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M04_AXI"
} else {
	puts "Data comparison test fail for - M04_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M05_AXI
set wdata_m05_axi [get_init_data 5]
create_hw_axi_txn w_m05_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m05_axi}
create_hw_axi_txn r_m05_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m05_axi_addr
run_hw_axi w_m05_axi_addr
run_hw_axi r_m05_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m05_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 8 5 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M05_AXI"
} else {
	puts "Data comparison test fail for - M05_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M06_AXI
set wdata_m06_axi [get_init_data 6]
create_hw_axi_txn w_m06_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m06_axi}
create_hw_axi_txn r_m06_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m06_axi_addr
run_hw_axi w_m06_axi_addr
run_hw_axi r_m06_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m06_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 8 6 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M06_AXI"
} else {
	puts "Data comparison test fail for - M06_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M07_AXI
set wdata_m07_axi [get_init_data 7]
create_hw_axi_txn w_m07_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m07_axi}
create_hw_axi_txn r_m07_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m07_axi_addr
run_hw_axi w_m07_axi_addr
run_hw_axi r_m07_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m07_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 8 7 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M07_AXI"
} else {
	puts "Data comparison test fail for - M07_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
