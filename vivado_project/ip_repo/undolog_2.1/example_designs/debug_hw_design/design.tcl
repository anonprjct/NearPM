...
proc create_ipi_design { offsetfile design_name } {
	...
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} CONFIG.C_M02_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000200} ] [get_bd_cells undolog_0]

	# Copy all address to undolog_v2_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/undolog_v2_1_include.tcl"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:undolog:2.1]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/undolog_v2_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "undolog_v2_1_hw_${i}"
