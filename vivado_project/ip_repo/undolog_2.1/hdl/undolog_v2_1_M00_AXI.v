...
`timescale 1 ns / 1 ps
    ...
    assign init_txn_pulse    = DMA_START || start_clobber;
    ...
    /*            //read dma MM-S
      ...
      reg start_clobber_reg;
      always @ ( posedge M_AXI_ACLK)                                                    
      begin                                                                             
        if (M_AXI_ARESETN == 1'b0)                                                     
          begin   
            start_clobber_reg <= 1'b0;
          end
        else
          begin
            if(start_clobber == 1'b1)
                start_clobber_reg <= 1'b1;
            if(DMA_START == 1'b1)
                start_clobber_reg <= 1'b0;
          end
      end
                     ...
                     begin                                                                 
                       ...
                       if (~axi_awvalid && ~axi_wvalid && ~M_AXI_BVALID &&  ~start_single_write && ~write_issued)
                         begin                                                           
                           ...
                           //should be a zero out region
                           wdata <= 32'hC0000000 | (32'h0FFFFFFF & DMA_SRC);//32'hc3000000;//DMA_SRC;
                         end                                                             
                       else if (axi_bready)                                              
                         begin                                                           
                           write_issued  <= 1'b0;                                        
                     ...
                     begin                                                                 
                       ...
                       if (~axi_awvalid && ~axi_wvalid && ~M_AXI_BVALID &&  ~start_single_write && ~write_issued)
                         begin                                                           
                           ...
                           wdata <= DMA_DEST;//32'hc4000000;//DMA_DEST;
                         end                                                              
                       else if (axi_bready)                                              
                         begin                                                           
                           write_issued  <= 1'b0;                                        
