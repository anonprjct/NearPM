# Runtime Tcl commands to interact with - undolog_v2_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/undolog_v2_0_include.tcl
...
set DE [ get_done_and_error_bit $rdata_tmp 4 0 ]
# Compare read data
if { $DE == 01 } {
...
set DE [ get_done_and_error_bit $rdata_tmp 4 1 ]
# Compare read data
if { $DE == 01 } {
...
set DE [ get_done_and_error_bit $rdata_tmp 4 2 ]
# Compare read data
if { $DE == 01 } {
...
set DE [ get_done_and_error_bit $rdata_tmp 4 3 ]
# Compare read data
if { $DE == 01 } {
