...
proc create_ipi_design { offsetfile design_name } {
	...
	set undolog_0 [ create_bd_cell -type ip -vlnv user.org:user:undolog:2.0 undolog_0 ]
	...
	set_property -dict [ list CONFIG.NUM_SI {5} ] $axi_mem_interconnect
	...
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S04_AXI] [get_bd_intf_pins axi_peri_interconnect/M02_AXI]
	...
	set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {4}  ] $axi_gpio_out
	...
	set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {8}  ] $axi_gpio_in
	...
	set_property -dict [ list CONFIG.DIN_TO {0} CONFIG.DIN_WIDTH {4}  ] $bit_0
	...
	set_property -dict [ list CONFIG.DIN_TO {1} CONFIG.DIN_WIDTH {4}  ] $bit_1
	...
	set_property -dict [ list CONFIG.DIN_TO {2} CONFIG.DIN_WIDTH {4}  ] $bit_2
	...
	set_property -dict [ list CONFIG.DIN_TO {3} CONFIG.DIN_WIDTH {4}  ] $bit_3
	...
	# Connect all clock & reset of undolog_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins undolog_0/S00_AXI]
	connect_bd_net [get_bd_pins undolog_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins undolog_0/S01_AXI]
	connect_bd_net [get_bd_pins undolog_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of undolog_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins undolog_0/M00_AXI]
	connect_bd_net [get_bd_pins undolog_0/m00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/m00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins undolog_0/m00_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins undolog_0/m00_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins undolog_0/m00_axi_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins undolog_0/M01_AXI]
	connect_bd_net [get_bd_pins undolog_0/m01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/m01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins undolog_0/m01_axi_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins undolog_0/m01_axi_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins undolog_0/m01_axi_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S02_AXI] [get_bd_intf_pins undolog_0/M02_AXI]
	connect_bd_net [get_bd_pins undolog_0/m02_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/m02_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins undolog_0/m02_axi_txn_done] [get_bd_pins xlconcat_0/In4]
	connect_bd_net [get_bd_pins undolog_0/m02_axi_error] [get_bd_pins xlconcat_0/In5]
	connect_bd_net [get_bd_pins undolog_0/m02_axi_init_axi_txn] [ get_bd_pins slice_block/Dout2 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S03_AXI] [get_bd_intf_pins undolog_0/M03_AXI]
	connect_bd_net [get_bd_pins undolog_0/m03_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins undolog_0/m03_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins undolog_0/m03_axi_txn_done] [get_bd_pins xlconcat_0/In6]
	connect_bd_net [get_bd_pins undolog_0/m03_axi_error] [get_bd_pins xlconcat_0/In7]
	connect_bd_net [get_bd_pins undolog_0/m03_axi_init_axi_txn] [ get_bd_pins slice_block/Dout3 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of undolog_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {undolog_0/M00_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {undolog_0/M01_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {undolog_0/M02_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {undolog_0/M03_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} CONFIG.C_M02_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000200} CONFIG.C_M03_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000300} ] [get_bd_cells undolog_0]

	# Copy all address to undolog_v2_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/undolog_v2_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_undolog_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_undolog_0_S01_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:undolog:2.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/undolog_v2_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "undolog_v2_0_hw_${i}"
