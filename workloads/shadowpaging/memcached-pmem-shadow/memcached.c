...
//		memcpy(shadow_start , pageStart,4096);
//		pmem_persist( shadow_start + 4096,4096);	 
				*((uint64_t*)device) = (uint64_t)(shadow_start + 4096);
				*((uint64_t*)(device)+1) = 00;
				*((uint64_t*)(device)+2) = (uint64_t)pageStart;
...
int main (int argc, char **argv) {
    size_t mapped_len1;
    int is_pmem1;
    if ((shadow_start = pmem_map_file("/mnt/mem/checkpoint", 4096*50,
